...
layout: page
title: "Shoebox"
description: "Odds and ends. The stuff that doesn't fit anywhere else."
date: 2026-02-25
permalink: /shoebox/
---
...
## Science Mike's Axioms

*Mike McHargue's framework for faith and doubt. [Original article on HuffPost](https://www.huffpost.com/entry/axioms-for-faith_b_8482932).*

Each axiom follows the structure: **Faith/God/Prayer/etc. is AT LEAST [minimal definition]. EVEN IF that's all it is, [the value it still holds].**
...
- **The Bible** is AT LEAST a collection of books and writings assembled by the Church that chronicle a people group's experiences with, and understanding of, God over thousands of years. Even if that is a comprehensive definition of the Bible, study of scripture is warranted to understand our culture and the way in which people experience God.

---

## Jellyfin Resources

Tools and plugins worth knowing about for Jellyfin self-hosters.

- [awesome-jellyfin](https://github.com/awesome-jellyfin/awesome-jellyfin) — Community-curated list of Jellyfin plugins, tools, and resources
- [ytdlp2STRM](https://github.com/fe80Grau/ytdlp2STRM) — Stream yt-dlp sources directly into Jellyfin
- [Wizarr](https://github.com/Wizarrrr/wizarr) / [docs](https://docs.wizarr.dev) — Invitation and onboarding system for Jellyfin
- [TitleCardMaker](https://github.com/CollinHeist/TitleCardMaker) / [titlecardmaker.com](https://titlecardmaker.com) — Automated title card generation for media libraries
- [subgen](https://github.com/McCloudS/subgen) — Auto-generate subtitles using OpenAI Whisper
- [Reiverr](https://github.com/aleksilassila/reiverr) — Combined Jellyfin + Radarr/Sonarr frontend
- [Jellyfin-Auto-Collections](https://github.com/ghomasHudson/Jellyfin-Auto-Collections?tab=readme-ov-file) — Automatically create and manage collections
- [Tunarr](https://github.com/chrisbenincasa/tunarr) — Create custom live TV channels from your media library

---

## Nintendo Device Resources

Homebrew and modding resources for Nintendo devices.

- [hb-app.store](https://hb-app.store) — Homebrew App Store web interface
- [hb-appstore (GitHub)](https://github.com/fortheusers/hb-appstore) — Source for the Homebrew App Store
- [Wii U Hacks Guide — Tiramisu](https://wiiu.hacks.guide/#/tiramisu/sd-preparation) — Step-by-step guide to setting up custom firmware on Wii U
